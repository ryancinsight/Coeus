...
pub fn dispatch_conv1d<T: WgpuScalar>(
    ...
    let shader_src = format!(
        ...
        fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {{
            ...
            for (var ic: u32 = 0u; ic < c_in; ic = ic + 1u) {{
                for (var ik: u32 = 0u; ik < k; ik = ik + 1u) {{
                    ...
                    if (l_in >= 0 && u32(l_in) < l) {{
                        let input_idx = get_physical_index_3d(input_layout, ni, ic, u32(l_in));
                        let weight_idx = get_physical_index_3d(weight_layout, oc, ic, ik);
            ...
            let output_idx = get_physical_index_3d(output_layout, ni, oc, ol);
...
pub fn dispatch_conv1d_backward<T: WgpuScalar>(
