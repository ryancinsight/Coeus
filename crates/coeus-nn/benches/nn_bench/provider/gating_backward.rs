...
pub(crate) fn bench_tanh_backward(c: &mut Criterion) {
    ...
    group.bench_function("Coeus Sequential", |b| {
        b.iter(|| {
            let o = coeus_autograd::tanh(black_box(&x_seq)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.bench_function("Coeus Moirai", |b| {
        b.iter(|| {
            let o = coeus_autograd::tanh(black_box(&x_moirai)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.finish();
...
pub(crate) fn bench_sigmoid_backward(c: &mut Criterion) {
    ...
    group.bench_function("Coeus Sequential", |b| {
        b.iter(|| {
            let o = coeus_autograd::sigmoid(black_box(&x_seq)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.bench_function("Coeus Moirai", |b| {
        b.iter(|| {
            let o = coeus_autograd::sigmoid(black_box(&x_moirai)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.finish();
...
pub(crate) fn bench_silu_backward(c: &mut Criterion) {
    ...
    group.bench_function("Coeus Sequential", |b| {
        b.iter(|| {
            let o = coeus_autograd::silu(black_box(&x_seq)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.bench_function("Coeus Moirai", |b| {
        b.iter(|| {
            let o = coeus_autograd::silu(black_box(&x_moirai)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.finish();
...
pub(crate) fn bench_mish_backward(c: &mut Criterion) {
    ...
    group.bench_function("Coeus Sequential", |b| {
        b.iter(|| {
            let o = coeus_autograd::mish(black_box(&x_seq)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.bench_function("Coeus Moirai", |b| {
        b.iter(|| {
            let o = coeus_autograd::mish(black_box(&x_moirai)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.finish();
...
pub(crate) fn bench_softsign_backward(c: &mut Criterion) {
    ...
    group.bench_function("Coeus Sequential", |b| {
        b.iter(|| {
            let o = coeus_autograd::softsign(black_box(&x_seq)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.bench_function("Coeus Moirai", |b| {
        b.iter(|| {
            let o = coeus_autograd::softsign(black_box(&x_moirai)).expect("run operation");
            black_box(o).backward().expect("run backward")
        })
    });
    group.finish();
