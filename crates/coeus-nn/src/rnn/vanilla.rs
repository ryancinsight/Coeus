...
impl<T: Float + coeus_leto::RandomScalar, B: coeus_ops::BackendOps<T> + Default> RNNCell<T, B> {
    ...
    pub fn new(
        ...
        Ok(Self {
            w_ih: Linear::<T, B>::new(input_size, hidden_size, true)?,
            w_hh: Linear::<T, B>::new(hidden_size, hidden_size, true)?,
            nonlinearity,
            input_size,
            hidden_size,
        })
    ...
    pub fn step(
        ...
        let pre = coeus_autograd::add(&x_proj, &h_proj)?;
        ...
        coeus_core::CpuAddressableStorage<T> + coeus_core::CpuAddressableStorageMut<T>,
{
    ...
    pub fn new(
        ...
        Ok(Self {
            cell: RNNCell::<T, B>::new(input_size, hidden_size, nonlinearity)?,
            input_size,
            hidden_size,
        })
    }
