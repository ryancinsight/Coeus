...
pub fn dispatch_max_pool3d<T: WgpuScalar>(
    ...
    let in_layout_gpu = try_layout("max_pool3d", input_layout, 5)?;
    let out_layout_gpu = try_layout("max_pool3d", output_layout, 5)?;
    let out_numel = checked_numel("max_pool3d", output_layout.shape())?;
    let workgroups = checked_workgroup_count("max_pool3d", out_numel)?;
...
pub fn dispatch_max_pool3d_backward<T: WgpuScalar>(
    ...
    let go_layout_gpu = try_layout("max_pool3d_backward", grad_out_layout, 5)?;
    let in_layout_gpu = try_layout("max_pool3d_backward", input_layout, 5)?;
    let gi_layout_gpu = try_layout("max_pool3d_backward", grad_input_layout, 5)?;
    let in_numel = checked_numel("max_pool3d_backward", grad_input_layout.shape())?;
    let workgroups = checked_workgroup_count("max_pool3d_backward", in_numel)?;
    let params_data = PoolParams {
        kernel_size: parameter(kernel_size, "kernel_size")?,
        stride: parameter(stride, "stride")?,
        padding: parameter(padding, "padding")?,
