    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let v = coeus_ops::linspace(0.0_f64, 4.0_f64, 5, backend).expect("run operation");
    ...
    let s = coeus_ops::linspace(1.0_f64, 1.0_f64, 1, backend).expect("run operation");
    assert_eq!(s.as_slice(), &[1.0_f64], "linspace n=1");

    // linspace(0, 10, 11): step=1, 0 through 10.
    let w = coeus_ops::linspace(0.0_f64, 10.0_f64, 11, backend).expect("run operation");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let v = coeus_ops::logspace(0.0_f64, 3.0_f64, 4, 10.0_f64, backend).expect("run operation");
    ...
    let v2 = coeus_ops::logspace(0.0_f64, 3.0_f64, 4, 2.0_f64, backend).expect("run operation");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let v = coeus_ops::geomspace(1.0_f64, 8.0_f64, 4, backend).expect("run operation");
    ...
    let c = coeus_ops::geomspace(1.0_f64, 1.0_f64, 3, backend).expect("run operation");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let grids = coeus_ops::meshgrid(&[&x, &y], "ij", backend).expect("run operation");
    ...
    let grids_xy = coeus_ops::meshgrid(&[&x, &y], "xy", backend).expect("run operation");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let nz = coeus_ops::nonzero(&m, backend).expect("run operation");
    ...
    let nzv = coeus_ops::nonzero(&v, backend).expect("run operation");
    ...
    let z = Tensor::<f64, B>::from_slice_on(vec![2, 2], &[0.0; 4], backend).expect("construct tensor");
    let nzz = coeus_ops::nonzero(&z, backend).expect("run operation");
