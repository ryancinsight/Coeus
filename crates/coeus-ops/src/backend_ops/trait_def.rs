...
use super::traits::{ConvOps, ElementwiseOps, MatmulOps, PoolOps, ReductionOps, UnfoldFoldOps};
...
/// (elementwise, matmul, conv, pooling, and unfold/fold) to the
/// underlying device. Attention is an optional capability expressed by
/// `AttentionOps` and stateful updates are optional capabilities expressed by
/// `OptimizerOps`. This trait is a **super-trait** composed of six
...
/// Blanket impl: any backend that implements all six required sub-traits automatically
