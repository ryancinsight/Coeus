...
{
    TensorDispatcher::avg_pool1d(input, kernel_size, stride, padding, ceil_mode, count_include_pad)
}
...
where
    ...
    T: DataType + num_traits::Float + num_traits::FromPrimitive + num_traits::Zero + PartialOrd + std::fmt::Debug,
{
    TensorDispatcher::avg_pool2d(input, kernel_size, stride, padding, ceil_mode, count_include_pad)
}
...
where
    ...
    T: DataType + num_traits::Float + num_traits::FromPrimitive + num_traits::Zero + PartialOrd + std::fmt::Debug,
{
    TensorDispatcher::avg_pool3d(input, kernel_size, stride, padding, ceil_mode, count_include_pad)
}
