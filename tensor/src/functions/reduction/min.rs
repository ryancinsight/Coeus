...
/// Min function for reduction operations
#[derive(Debug)]
pub struct MinFunction<B, S, T>
where
    B: Backend<Data = T>,
...
impl<B, S, T> Function<B, S, T> for MinFunction<B, S, T>
where
...
impl<B, S, T> DifferentiableFunction<B, S, T> for MinFunction<B, S, T>
where
    B: Backend<Data = T>,
    S: Storage<T> + StorageFromVec<T>,
    T: DataType,
...
impl<B, S, T> crate::AsAny for MinFunction<B, S, T>
where
    B: Backend<Data = T>,
    S: Storage<T> + StorageFromVec<T>,
    T: DataType,
