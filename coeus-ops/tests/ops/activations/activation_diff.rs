    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let s = coeus_ops::sigmoid(&z, backend).expect("valid sigmoid test input");
    ...
    let sv = coeus_ops::sigmoid(&v, backend).expect("valid sigmoid test input");
    assert_close_f64(
        sv.as_slice(),
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let z = t(&[1], &[0.0_f64], backend);
    let g = coeus_ops::gelu(&z, backend).expect("valid GELU test input");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let z = t(&[1], &[0.0_f64], backend);
    let g = coeus_ops::gelu_tanh(&z, backend).expect("valid tanh GELU test input");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let z = t(&[1], &[0.0_f64], backend);
    let s = coeus_ops::silu(&z, backend).expect("valid SiLU test input");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let z = t(&[1], &[0.0_f64], backend);
    let m = coeus_ops::mish(&z, backend).expect("valid Mish test input");
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let e_pos = coeus_ops::elu(&pos, backend).expect("valid positive ELU test input");
    assert_eq!(
        e_pos.as_slice(),
        &[0.0_f64, 1.0, 4.0],
    ...
    let e_neg = coeus_ops::elu(&neg, backend).expect("valid negative ELU test input");
    assert_close_f64(
        e_neg.as_slice(),
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let z = t(&[1], &[0.0_f64], backend);
    let sp = coeus_ops::softplus(&z, backend).expect("valid softplus test input");
    assert_close_f64(
        sp.as_slice(),
        &[std::f64::consts::LN_2],
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let lr = coeus_ops::leaky_relu(&v, backend, 0.25).expect("valid leaky ReLU test input");
    assert_eq!(
        lr.as_slice(),
    ...
    let lr2 = coeus_ops::leaky_relu(&v2, backend, 0.125).expect("valid leaky ReLU test input");
    assert_eq!(
        lr2.as_slice(),
        &[-12.5_f64, -0.125, 5.0],
