    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let cp = coeus_ops::cumprod(&v, 0, backend);
    ...
    let cp_dim0 = coeus_ops::cumprod(&m, 0, backend);
    ...
    // -> [[1,2],[3,12]]
    let cp_dim1 = coeus_ops::cumprod(&m, 1, backend);
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let out = coeus_ops::broadcast_to(&v, &[2, 3], backend);
    ...
    let out2 = coeus_ops::broadcast_to(&col, &[2, 3], backend);
    ...
    let m = t(&[2, 2], &[1.0, 2.0, 3.0, 4.0], backend);
    let id = coeus_ops::broadcast_to(&m, &[2, 2], backend);
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let parts = coeus_ops::chunk(&v, 2, 0);
    ...
    let parts2 = coeus_ops::chunk(&m, 2, 1);
    ...
    let parts3 = coeus_ops::chunk(&v6, 3, 0);
    ...
    B::DeviceBuffer<f64>: CpuAddressableStorage<f64> + CpuAddressableStorageMut<f64>,
{
    ...
    let d = coeus_ops::diag(&v, 0, backend);
    ...
    let d1 = coeus_ops::diag(&v2, 1, backend);
    ...
    // [[0,0,0],[1,0,0],[0,2,0]]
    let d_neg = coeus_ops::diag(&v2, -1, backend);
    ...
    let diag_main = coeus_ops::diagonal(&m, 0, backend);
    ...
    let diag_rect = coeus_ops::diagonal(&rect, 0, backend);
