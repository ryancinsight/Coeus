...
/// let b = exp(&a, &backend).expect("valid exponential doctest inputs");
/// let s = b.as_slice();
...
/// let b = erf(&a, &backend).expect("valid error-function doctest inputs");
/// let s = b.as_slice();
...
/// let b = neg(&a, &backend).expect("valid negation doctest inputs");
...
/// let b = sqrt(&a, &backend).expect("valid square-root doctest inputs");
/// let s = b.as_slice();
/// assert!((s[0] - 1.0).abs() < 1e-5);
...
#[inline]
pub fn sin_assign<T: Float, B: BackendOps<T>>(
...
#[inline]
pub fn cos_assign<T: Float, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn exp_assign<T: Float, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn log_assign<T: Float, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn neg_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn sqrt_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn recip_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn sign_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn floor_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn ceil_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn round_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
...
#[inline]
pub fn trunc_assign<T: Scalar, B: BackendOps<T>>(
    input: &mut Tensor<T, B>,
    backend: &B,
) -> Result<(), B::Error> {
