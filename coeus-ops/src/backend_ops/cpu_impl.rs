    ...
    B::DeviceBuffer<T>: CpuAddressableStorageMut<T>,
{
    ...
    fn elementwise_binary(
        ...
        binary::elementwise_binary(self, op, a, a_layout, b, b_layout, c, c_layout);
    }
    ...
    fn elementwise_unary(
        ...
        binary::elementwise_unary(self, op, a, a_layout, c, c_layout);
    }
    ...
    fn reduce(
        ...
        matmul::reduce(self, op, a, a_layout, axis, c, c_layout);
    }
