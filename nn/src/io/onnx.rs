...
impl OnnxImporter {
    ...
    pub fn import_linear_from_onnx<T: DataType + FloatExt>(
    ...
    ) -> Result<crate::modules::linear::Linear<CpuBackend<T>, DenseStorage<T>, T>> {
        ...
        let weight_param = crate::core::parameter::Parameter::new(
            weight.clone().requires_grad_(true),
            "weight".to_string(),
        );
        let bias_param =
            crate::core::parameter::Parameter::new(bias.requires_grad_(true), "bias".to_string());
