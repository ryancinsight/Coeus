    ...
    T: DataType + FloatExt + num_traits::FromPrimitive + num_traits::Bounded + 'static,
{
    ...
    model: Arc<crate::clip::models::clip::ClipModel<B, storage::DenseStorage<T>, T>>,
        ...
        + 'static,
{
    ...
    async fn evaluate_zero_shot_classification(
        ...
        let _class_embeddings = self.model.encode_text(&class_prompt_refs)?;
        ...
        for i in 0..eval_samples {
            ...
            let _image_embedding = self.model.encode_image(&image_data, 1)?;
