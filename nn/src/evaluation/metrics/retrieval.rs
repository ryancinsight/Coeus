...
use crate::evaluation::{ClipEvaluationConfig, ClipModelEvaluator, EvaluationDataset};
...
impl RetrievalEvaluator {
        ...
        M: ClipModelEvaluator,
    {
        ...
        let i2t_ranks = self.compute_retrieval_ranks(&i2t_similarities)?;
        let t2i_ranks = self.compute_retrieval_ranks(&t2i_similarities)?;
