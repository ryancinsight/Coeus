//! TPU multiplication operations
//!
//! This module provides TPU-optimized element-wise multiplication primitives.

use dtype::DataType;

/// Element-wise multiplication primitive for TPU
///
...
/// Element-wise multiplication with scalar primitive for TPU
///
