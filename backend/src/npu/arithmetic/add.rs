//! NPU addition operations
//!
//! This module provides NPU-optimized element-wise addition primitives.

use dtype::DataType;

/// Element-wise addition primitive for NPU
///
...
/// NPU-specific APIs and optimizations.
...
/// Element-wise addition with scalar primitive for NPU
///
