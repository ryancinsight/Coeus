//! NPU subtraction operations
//!
//! This module provides NPU-optimized element-wise subtraction primitives.

use dtype::DataType;

/// Element-wise subtraction primitive for NPU
///
...
/// Element-wise subtraction with scalar primitive for NPU
///
