//! NPU tanh activation operations
//!
//! This module provides NPU-optimized tanh activation primitives.

use dtype::DataType;

/// Tanh activation primitive for NPU
///
...
/// Tanh gradient primitive for NPU
///
...
where
    T: Copy,
{
    // TODO: Implement tanh gradient for NPU
    Err(crate::BackendError::UnsupportedOperation {
