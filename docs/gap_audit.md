...
## ATLAS-CUDA-SAFETY-007: Remaining CUDA launch-parameter narrowing
...
`ATLAS-CUDA-SAFETY-006`, but other CUDA kernel families still narrow launch
...
layout, reduction, elementwise, or optimizer migrations.
