...
## ATLAS-CUDA-SAFETY-010: Remaining CUDA launch-parameter narrowing
...
`ATLAS-CUDA-SAFETY-008` and `ATLAS-CUDA-SAFETY-009`, but other CUDA kernel
...
not silently folded into the layout, reduction, elementwise, optimizer, or
pooling migrations.
