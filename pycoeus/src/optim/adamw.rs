...
/// AdamW optimizer
#[pyclass(name = "AdamW", module = "coeus", subclass, unsendable)]
pub struct PyAdamW {
    pub inner: RustAdamW<CpuBackend<Float32>, DenseStorage<Float32>, Float32>,
}

#[pymethods]
impl PyAdamW {
    #[new]
    #[pyo3(signature = (params, lr=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8, weight_decay=0.01))]
    fn new(
        params: Vec<PyTensor>,
        lr: f64,
        beta1: f64,
...
crate::impl_optimizer_methods!(PyAdamW);
