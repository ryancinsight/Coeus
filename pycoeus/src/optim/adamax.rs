...
use optim::adamax::Adamax as RustAdamax;
use pyo3::prelude::*;
...
#[pyclass(name = "Adamax", module = "coeus", subclass, unsendable)]
pub struct PyAdamax {
    pub inner: RustAdamax<CpuBackend<Float32>, DenseStorage<Float32>, Float32>,
}

#[pymethods]
impl PyAdamax {
    #[new]
    #[pyo3(signature = (params, lr=0.002, beta1=0.9, beta2=0.999, epsilon=1e-8, weight_decay=0.0))]
    fn new(
        params: Vec<PyTensor>,
        lr: f64,
        beta1: f64,
        ...
        let adamax =
            RustAdamax::with_hyperparams(rust_params, lr, beta1, beta2, epsilon, weight_decay);
        Ok(PyAdamax { inner: adamax })
    }
...
crate::impl_optimizer_methods!(PyAdamax);
