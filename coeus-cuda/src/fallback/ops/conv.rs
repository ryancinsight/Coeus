#![allow(
    ...
    reason = "fallback methods mirror the BackendOps convolution boundary signatures"
)]
...
impl CudaBackend {
    ...
    pub(crate) fn fallback_conv1d_backward<T: CudaScalar>(
        &self,
    ...
    pub(crate) fn fallback_conv2d_backward<T: CudaScalar>(
        &self,
        grad_out: &CudaStorage<T>,
        grad_out_layout: &Layout,
        input: &CudaStorage<T>,
    ...
    pub(crate) fn fallback_conv_transpose1d<T: CudaScalar + coeus_core::Float>(
        &self,
        input: &CudaStorage<T>,
        input_layout: &Layout,
        weight: &CudaStorage<T>,
    ...
    pub(crate) fn fallback_conv_transpose2d<T: CudaScalar + coeus_core::Float>(
        &self,
        input: &CudaStorage<T>,
        input_layout: &Layout,
        weight: &CudaStorage<T>,
