#!/usr/bin/env python3
"""
Test script for PyTensor NumPy buffer protocol support.
This tests the __array__ method implementation.
"""
...
try:
    ...
    print("and that the Python path includes the built extension.")
    sys.exit(1)
...
try:
    ...
    # Try to import the compiled PyCoeus module
    try:
        import _coeus
        print("✅ PyCoeus module imported successfully")

        # Test basic tensor creation
        print("Testing tensor creation...")
        tensor = _coeus.Tensor([1.0, 2.0, 3.0, 4.0], [2, 2])
        ...
        tensor2 = _coeus.Tensor([5.0, 6.0, 7.0, 8.0], [2, 2])
        ...
        print(f"❌ Failed to import PyCoeus: {e}")
        print("Note: Make sure to build the extension with 'cd pycoeus && cargo build --release'")
        print("and that the Python path includes the built extension.")
        sys.exit(1)
