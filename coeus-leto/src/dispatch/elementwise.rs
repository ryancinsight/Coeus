...
fn unary_n<T: LetoScalar + CoeusScalar + CpuUnaryDispatch, const N: usize>(
    ...
    match op {
        ...
        UnaryOp::Erfc => apply!(|x: T| T::eval_unary(UnaryOp::Erfc, x)),
        UnaryOp::Lgamma => apply!(|x: T| T::eval_unary(UnaryOp::Lgamma, x)),
        UnaryOp::Tan => apply!(|x: T| T::eval_unary(UnaryOp::Tan, x)),
        UnaryOp::Asin => apply!(|x: T| T::eval_unary(UnaryOp::Asin, x)),
        UnaryOp::Acos => apply!(|x: T| T::eval_unary(UnaryOp::Acos, x)),
        UnaryOp::Atan => apply!(|x: T| T::eval_unary(UnaryOp::Atan, x)),
        UnaryOp::Sinh => apply!(|x: T| T::eval_unary(UnaryOp::Sinh, x)),
        UnaryOp::Cosh => apply!(|x: T| T::eval_unary(UnaryOp::Cosh, x)),
        UnaryOp::Log2 => apply!(|x: T| T::eval_unary(UnaryOp::Log2, x)),
        UnaryOp::Log10 => apply!(|x: T| T::eval_unary(UnaryOp::Log10, x)),
        UnaryOp::Exp2 => apply!(|x: T| T::eval_unary(UnaryOp::Exp2, x)),
        UnaryOp::Atanh => apply!(|x: T| T::eval_unary(UnaryOp::Atanh, x)),
        UnaryOp::Asinh => apply!(|x: T| T::eval_unary(UnaryOp::Asinh, x)),
        UnaryOp::Acosh => apply!(|x: T| T::eval_unary(UnaryOp::Acosh, x)),
        UnaryOp::Expm1 => apply!(|x: T| T::eval_unary(UnaryOp::Expm1, x)),
        UnaryOp::Log1p => apply!(|x: T| T::eval_unary(UnaryOp::Log1p, x)),
